...
class NFATestCase(unittest.TestCase):
    ...
    def test_eclose(self):
        self.assertEqual(self.a._eclose(0), frozenset({0, 1}))
        self.assertEqual(self.a._eclose(1), frozenset({1}))
        self.assertEqual(self.a._eclose(2), frozenset({2}))
        self.assertEqual(self.a._eclose(3), frozenset({3, 5}))
        self.assertEqual(self.a._eclose(4), frozenset({4}))
        self.assertEqual(self.a._eclose(5), frozenset({5}))
        self.assertEqual(self.a._eclose(
